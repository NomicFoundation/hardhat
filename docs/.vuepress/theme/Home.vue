    ...
    <div class="home">
            ...
            <div class="testimonial">
              <div class="testimonial-left">
                <div class="testimonial-img">
                  <img class="author-img" :src="item.authorImg" :alt="item.author">
                </div>
                <div class="testimonial-data">
                  <span class="author-name">{{ item.author }}</span>
                  <span class="author-role">{{ item.role }} at {{ item.company }}</span>
                  <img class="author-company" :src="item.companyImg" :alt="item.company">
                </div>
              </div>
      ...
      <div class="footer" v-if="data.footer">
        <div class="ef">
          ...
          <img src="/ethereum_fundation.png" alt="Supported by Ethereum Foundation">
        </div>
        <p>{{ data.footer }}</p>
      </div>
...
export default {
    ...
    return {
      pages:[
        ...
        },
        {
          ...
          role: "CTO",
          company: "Aragon One",
          companyImg: "/users/aone-logo-testimonial.png",
          text: "Our interest in Buidler was driven by our own experience of building and maintaining developer tooling for the Aragon ecosystem. Not only were these efforts time consuming, difficult, and error-prone, we also found ourselves constantly re-inventing the wheel in areas we did not want to care about or force opinions on (e.g. Ganache connections, Truffle providers, test strategy). Buidler, with its plugin ecosystem, has effectively eliminated many of these problems for us. We feel confident piggybacking on the best for the underlying layers so that we can focus our attention on exposing the power of the Aragon ecosystem to our community."
        },
        {
        ...
        },
        {
          ...
          companyImg: "/users/decentraland-logo-testimonial.png",
          text: "Buidler's extensibility, clean interface and excellent design is the most significant advancement in the professionalization of tools for Ethereum of the past year. Our development experience improved significantly, and the quality of the development process is reflected in the fact that our team went from fearing updating packages to the latest version to watching out for the next release."
        },
        {
  ...
  components: { NavLink, slider, slideritem },
  computed: {
    data() {
