...
export const TrustedTeamsLogos = [
  ...
  {
    img: require("./connext.png"),
    alt: "Connext company logo",
  },
  { img: require("./set.png"), alt: "Set company logo" },
  {
    img: require("./opyn.png"),
    alt: "Opyn company logo",
  },
  {
    img: require("./balancer.png"),
    alt: "Balancer company logo",
  },
  {
    img: require("./molochdao.png"),
    alt: "Molochdao company logo",
  },
  {
    img: require("./kyber.png"),
    alt: "Kyber company logo",
  },
  {
    img: require("./openzeppelin.png"),
    alt: "Openzepellin company logo",
  },
  {
    img: require("./pieDAO.png"),
    alt: "PieDAO company logo",
  },
  {
    img: require("./optimism.png"),
    alt: "Optimism company logo",
  },
  {
    img: require("./decentraland.png"),
  ...
  {
    img: require("./mstable.png"),
    alt: "M STABLE company logo",
  },
  {
    img: require("./celo.png"),
    alt: "Celo company logo",
  },
  {
    img: require("./mycrypto.png"),
    alt: "MyCrypto company logo",
  },
  {
    img: require("./poap.png"),
    alt: "Poap company logo",
  },
  {
    img: require("./melon.png"),
    alt: "Melon company logo",
  },
  {
    img: require("./openGSN.png"),
    alt: "OpenGSN company logo",
  },
  {
    img: require("./unlock.png"),
    alt: "Unlock company logo",
  },
  {
    img: require("./status.png"),
    alt: "Status company logo",
  },
  {
    img: require("./pool.png"),
    alt: "Pool company logo",
  },
  {
    img: require("./instadapp.png"),
    alt: "Instadapp company logo",
  },
  {
    img: require("./mainframe.png"),
    alt: "Mainframe company logo",
  },
  {
    img: require("./horizon.png"),
    alt: "Horizon company logo",
  },
  {
    img: require("./aave.png"),
    alt: "Aave company logo",
  },
  {
    img: require("./skale.png"),
    alt: "Skale company logo",
  },
  {
    img: require("./synthetix.png"),
    alt: "Synthetix company logo",
  },
  {
    img: require("./celer.png"),
    alt: "Celer company logo",
  },
  { img: require("./uma.png"), alt: "Uma company logo" },
  {
    img: require("./chainlink.png"),
    alt: "Chainlink company logo",
  },
  {
    img: require("./gnosis.png"),
    alt: "Gnosis company logo",
  },
  {
    img: require("./sushiswap.png"),
    alt: "Sushiswap company logo",
  },
  { img: require("./ens.png"), alt: "ENS company logo" },
  {
    img: require("./yearn.png"),
    alt: "Yearn company logo",
  },
  {
    img: require("./reflexer.png"),
    alt: "Reflexer company logo",
  },
  {
    img: require("./dharma.png"),
    alt: "Dharma company logo",
  },
  {
    img: require("./1inch.png"),
    alt: "1inch company logo",
  },
  {
    img: require("./uniswap.png"),
    alt: "Uniswap company logo",
  },
  {
    img: require("./hegic.png"),
    alt: "Hegic company logo",
  },
  {
    img: require("./augur.png"),
    alt: "Augur company logo",
  },
  {
    img: require("./zksync.png"),
    alt: "zkSync company logo",
  },
  {
    img: require("./livepeer.png"),
    alt: "Livepeer company logo",
  },
  {
    img: require("./loopring.png"),
