...
impl Eip4844SignedTransaction {
    ...
    pub fn new(
        env: &Env,
        transaction: &rethnet_eth::transaction::Eip4844SignedTransaction,
    ) -> napi::Result<Self> {
...
impl TryFrom<Eip4844SignedTransaction> for rethnet_eth::transaction::Eip4844SignedTransaction {
