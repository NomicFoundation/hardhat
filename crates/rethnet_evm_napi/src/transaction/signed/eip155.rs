...
impl TryFrom<EIP155SignedTransaction> for rethnet_eth::transaction::EIP155SignedTransaction {
    type Error = napi::Error;

    fn try_from(value: EIP155SignedTransaction) -> Result<Self, Self::Error> {
        Ok(Self {
