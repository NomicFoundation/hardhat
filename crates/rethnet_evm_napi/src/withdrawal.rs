...
impl From<rethnet_eth::withdrawal::Withdrawal> for Withdrawal {
    fn from(withdrawal: rethnet_eth::withdrawal::Withdrawal) -> Self {
        Self {
...
impl TryFrom<Withdrawal> for rethnet_eth::withdrawal::Withdrawal {
