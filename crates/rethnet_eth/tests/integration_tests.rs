...
fn test_serde_eth_call() {
    ...
    help_test_method_invocation_serde(MethodInvocation::Call(tx.clone(), None));
    help_test_method_invocation_serde(MethodInvocation::Call(
        tx,
...
fn test_serde_eth_estimate_gas() {
    ...
    help_test_method_invocation_serde(MethodInvocation::EstimateGas(tx.clone(), None));
    help_test_method_invocation_serde(MethodInvocation::EstimateGas(
        tx,
        Some(BlockSpec::Number(U256::from(100))),
    ));
...
#[test]
fn test_serde_eth_get_code_without_block_spec() {
    help_test_method_invocation_serde(MethodInvocation::GetCode(Address::from_low_u64_ne(1), None));
}
...
#[test]
fn test_serde_eth_get_storage_at_without_block_tag() {
    help_test_method_invocation_serde(MethodInvocation::GetStorageAt(
        Address::from_low_u64_ne(1),
        U256::ZERO,
        None,
