...
`,
        ...
        websiteDescription: `The configuration you provided is seemngly valid, but once resolved it contains errors. Please check the documentation to learn how to configure Hardhat correctly.`,
      },
    },
    INTERNAL: {
      ASSERTION_ERROR: {
