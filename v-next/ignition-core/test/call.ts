...
import { validateNamedContractCall } from "../src/internal/validation/futures/validateNamedContractCall.js";
  ...
  describe("passing id", () => {
    ...
    it("should throw if the same function is called twice without differentiating ids", () => {
      assertThrowsHardhatError(
        ...
        {
          message: `The autogenerated future id ("Module1#SameContract.test") is already used. Please provide a unique id, as shown below:
