...
Check [our guide to configuration variables](https://hardhat.org/docs/tutorial/configuration-variables) to learn how to use the keystore in your Hardhat configuration.
