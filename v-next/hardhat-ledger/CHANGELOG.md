...
- 6afeb03: Fixed a bug in `hardhat-ledger` to handle cases where the `eth_accounts` method is not supported on certain networks [7885](https://github.com/NomicFoundation/hardhat/pull/7885).
