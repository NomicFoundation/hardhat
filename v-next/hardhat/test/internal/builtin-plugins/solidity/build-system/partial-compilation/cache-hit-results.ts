...
contract Foo {}`,
      ...
      assert(hre.solidity.isSuccessfulBuildResult(firstResult), "First build should succeed");
      ...
      assert(hre.solidity.isSuccessfulBuildResult(secondResult), "Second build should succeed");
...
contract Foo { uint256 public value; }`,
      ...
      assert(hre.solidity.isSuccessfulBuildResult(result), "Build should succeed");
