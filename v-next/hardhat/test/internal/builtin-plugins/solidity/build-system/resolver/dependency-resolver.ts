            ...
            ),
            {
              ...
              value: {
                file: {
                  ...
                  inputSourceName: "npm/dep@1.2.3/contracts/A.sol",
                  package: {
                    name: "dep",
                    version: "1.2.3",
                    rootFsPath: path.join(project.path, "node_modules/dep"),
            ...
            await resolver.resolveNpmDependencyFileAsRoot("exports/H.sol"),
            {
              ...
              value: {
                file: {
                  ...
                  inputSourceName: "npm/exports@1.2.4/src/H.sol",
                  package: {
                    name: "exports",
                    version: "1.2.4",
                    rootFsPath: path.join(project.path, "node_modules/exports"),
                    inputSourceNameRoot: "npm/exports@1.2.4",
                    exports: {
                      "./*.sol": "./src/*.sol",
                    },
                  },
          ...
          await resolver.resolveNpmDependencyFileAsRoot("other-exports/I.sol"),
          {
            ...
            value: {
              file: {
                ...
                inputSourceName: "npm/exports@1.2.4/other/I.sol",
                package: {
                  name: "exports",
                  version: "1.2.4",
                  rootFsPath: path.join(project.path, "node_modules/exports"),
            ...
            ),
            {
              ...
              value: {
                file: {
                  ...
                  inputSourceName: "npm/dep@1.2.4/in-root.sol",
            ...
            await resolver.resolveImport(result.value, importPath),
            {
              ...
              value: {
                file: {
                  ...
                  inputSourceName: "project/bar/B.sol",
                  package: result.value.package,
                },
                remapping: {
                  context: "project/",
            ...
            await resolver.resolveImport(result.value, "foo/B.sol"),
            {
              ...
              value: {
                file: {
                  ...
                  inputSourceName: "npm/foo@1.2.3/src/B.sol",
                  package: {
                    name: "foo",
                    version: "1.2.3",
                    rootFsPath: path.join(project.path, "node_modules/foo"),
                    inputSourceNameRoot: "npm/foo@1.2.3",
                    exports: undefined,
                  },
                },
                remapping: {
            ...
            await resolver.resolveImport(depFileResult.value.file, "foo/C.sol"),
            {
              ...
              value: {
                file: {
                  ...
                  inputSourceName: "npm/foo@1.2.3/bar/C.sol",
                  package: {
                    name: "foo",
                    version: "1.2.3",
                    rootFsPath: path.join(project.path, "node_modules/foo"),
                ...
                remapping: {
                  context:
                    depFileResult.value.file.package.inputSourceNameRoot + "/",
                  prefix: "foo/",
            ...
            await resolver.resolveImport(depFileResult.value.file, "d/C.sol"),
            {
              ...
              value: {
                file: {
                  ...
                  inputSourceName: "npm/peer-dep@1.2.4/src/C.sol",
                  package: {
                    name: "peer-dep",
                    version: "1.2.4",
                    ...
                    inputSourceNameRoot: "npm/peer-dep@1.2.4",
                    exports: undefined,
                  },
                },
                remapping: {
...
submodule2/=lib/submodule2/src/`,
          ...
          assert.ok(resultB.success, "Result should be successful");
          assert.equal(
            resultB.value.file.inputSourceName,
          ...
          assert.ok(resultC.success, "Result should be successful");
          assert.equal(
            resultC.value.file.inputSourceName,
          ...
          assert.equal(
            resultD.value.file.inputSourceName,
          ...
          assert.equal(
            resultE.value.file.inputSourceName,
          ...
          assert.deepEqual(depSrcDResult, {
            ...
            value: {
              file: {
                ...
                inputSourceName: "npm/dep@1.2.4/src/D.sol",
                package: {
                  name: "dep",
                  version: "1.2.4",
                  rootFsPath: path.join(project.path, "node_modules/dep"),
                  inputSourceNameRoot: "npm/dep@1.2.4",
                  exports: undefined,
                },
              },
              remapping: {
            ...
            ),
            {
              ...
              value: {
                file: {
                  ...
                  inputSourceName: "npm/transitive@1.2.5/src/E.sol",
                  package: {
                    name: "transitive",
                    version: "1.2.5",
                    rootFsPath: path.join(
                    ...
                    inputSourceNameRoot: "npm/transitive@1.2.5",
                    exports: undefined,
                  },
                },
                remapping: {
                  context:
                    depSrcDResult.value.file.package.inputSourceNameRoot + "/",
                  prefix: "transitive/",
            ...
            ),
            {
              ...
              value: {
                file: {
                  ...
                  inputSourceName: "npm/with-package-exports@1.2.6/same.sol",
                  package: {
                    name: "with-package-exports",
                    version: "1.2.6",
                    rootFsPath: path.join(
                    ...
                    inputSourceNameRoot: "npm/with-package-exports@1.2.6",
                    exports: {
                      "./same.sol": "./same.sol",
                      "./*.sol": "./src/*.sol",
                    },
            ...
            ),
            {
              ...
              value: {
                file: {
                  ...
                  inputSourceName: "npm/with-package-exports@1.2.6/src/F.sol",
                  package: {
                    name: "with-package-exports",
                    version: "1.2.6",
                    rootFsPath: path.join(
