...
import { LocalAccounts } from "../../../../../../../src/internal/builtin-plugins/network-manager/json-rpc-request-modifiers/accounts/local-accounts.js";
...
describe("LocalAccounts", () => {
  ...
  beforeEach(() => {
    ...
    localAccounts = new LocalAccounts(mockedProvider, accounts);
  });
    ...
    describe("eth_sign", () => {
      ...
      it("Should throw if the address isn't one of the local ones", async () => {
        ...
        await assertRejectsWithHardhatError(
          () => localAccounts.resolveRequest(jsonRpcRequest),
