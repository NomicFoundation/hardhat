...
/**
 * Given a list of ResolvedFiles, returns a tuple of two arrays:
 * 1. The list of licenses found in the files
 * 2. The list of files without licenses
 */
...
/**
 * Given a list of ResolvedFiles, returns a tuple of three elements:
 * 1. The pragma abicoder directive with highest importance found in the files
 * 2. The list of files without pragma abicoder directives
 * 3. The list of files with a different pragma abicoder directive
 */
...
/**
 * Given a dependency graph, returns the list of files in topological order.
 */
