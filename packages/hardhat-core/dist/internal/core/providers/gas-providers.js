...
class AutomaticGasPriceProvider extends wrapper_1.ProviderWrapper {
    async request(args) {
        ...
        let maxFeePerGas = tx.maxFeePerGas !== undefined
            ? (0, base_types_1.rpcQuantityToBN)(tx.maxFeePerGas)
            : suggestedEip1559Values.maxFeePerGas;
        const maxPriorityFeePerGas = tx.maxPriorityFeePerGas !== undefined
            ? (0, base_types_1.rpcQuantityToBN)(tx.maxPriorityFeePerGas)
    ...
    async _suggestEip1559FeePriceValues() {
        ...
        try {
            ...
            return {
                ...
                // next N blocks here.
                maxFeePerGas: (0, base_types_1.rpcQuantityToBN)(response.baseFeePerGas[1])
                    ...
                    1))),
                maxPriorityFeePerGas: (0, base_types_1.rpcQuantityToBN)(response.reward[0][0]),
            };
        }
        catch (_a) {
