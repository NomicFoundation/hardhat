...
class JsonRpcClient {
    ...
    async getBlockByNumber(blockNumber, includeTransactions = false) {
        ...
        return this._perform("eth_getBlockByNumber", [(0, base_types_1.numberToRpcQuantity)(blockNumber), false], (0, io_ts_1.nullable)(block_1.rpcBlock), (block) => { var _a; return (_a = block === null || block === void 0 ? void 0 : block.number) !== null && _a !== void 0 ? _a : undefined; });
    }
    async getBlockByHash(blockHash, includeTransactions = false) {
        if (includeTransactions) {
            return this._perform("eth_getBlockByHash", [(0, ethereumjs_util_1.bufferToHex)(blockHash), true], (0, io_ts_1.nullable)(block_1.rpcBlockWithTransactions), (block) => { var _a; return (_a = block === null || block === void 0 ? void 0 : block.number) !== null && _a !== void 0 ? _a : undefined; });
        }
        return this._perform("eth_getBlockByHash", [(0, ethereumjs_util_1.bufferToHex)(blockHash), false], (0, io_ts_1.nullable)(block_1.rpcBlock), (block) => { var _a; return (_a = block === null || block === void 0 ? void 0 : block.number) !== null && _a !== void 0 ? _a : undefined; });
    }
    async getTransactionByHash(transactionHash) {
        return this._perform("eth_getTransactionByHash", [(0, ethereumjs_util_1.bufferToHex)(transactionHash)], (0, io_ts_1.nullable)(transaction_1.rpcTransaction), (tx) => { var _a; return (_a = tx === null || tx === void 0 ? void 0 : tx.blockNumber) !== null && _a !== void 0 ? _a : undefined; });
    }
    ...
    async getTransactionReceipt(transactionHash) {
        return this._perform("eth_getTransactionReceipt", [(0, ethereumjs_util_1.bufferToHex)(transactionHash)], (0, io_ts_1.nullable)(receipt_1.rpcTransactionReceipt), (tx) => { var _a; return (_a = tx === null || tx === void 0 ? void 0 : tx.blockNumber) !== null && _a !== void 0 ? _a : undefined; });
    }
