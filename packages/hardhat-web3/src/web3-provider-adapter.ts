...
// This provider doesn't have the EventEmitter API.
// This results in a fast failure whenever a subscription is requested.
...
// Currently, the only difference between this provider and the HTTP one
// is the handling of `eth_subscription` notifications.
export class Web3HardhatNetworkProviderAdapter extends EventEmitter {
  private readonly _provider: EthereumProvider;
