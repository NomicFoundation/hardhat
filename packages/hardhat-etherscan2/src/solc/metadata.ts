...
const SOLC_NOT_FOUND_IN_METADATA_VERSION_RANGE = "0.4.7 - 0.5.8";
const MISSING_METADATA_VERSION_RANGE = "<0.4.7";
...
const getSolcMetadataSectionLength = (bytecode: Buffer) =>
