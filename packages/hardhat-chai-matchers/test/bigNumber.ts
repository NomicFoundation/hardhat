  ...
  describe("with two arguments", function () {
    ...
    operators.forEach((operator: Operator) => {
      ...
      describe("should throw when comparing to an unsafe integer", function () {
        ...
        const msg = `Cannot convert unsafe integer ${unsafeInt} to BigInt. Consider using ${unsafeInt}n instead. For more details, see https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number/isSafeInteger`;
