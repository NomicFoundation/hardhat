      ...
      describe("Change balance, one account", () => {
        ...
        it("Should throw when actual balance change value does not satisfy the predicate", async () => {
          await expect(
            ...
            AssertionError,
            `Expected the ether balance change of "${sender.account.address}" to satisfy the predicate, but it didn't (balance change: -200 wei)`
          );
        });
        ...
        it("Should throw in negative case when expected balance change value satisfies the predicate", async () => {
          await expect(
            ...
            AssertionError,
            `Expected the ether balance change of "${sender.account.address}" to NOT satisfy the predicate, but it did (balance change: -200 wei)`
          );
        });
