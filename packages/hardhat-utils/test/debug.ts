...
describe("debug", () => {
  ...
  describe("selectColor", () => {
    ...
    it("distributes the live monorepo namespaces with at most 3 per colour", () => {
      const namespaces = [
        "hardhat:core:cli:init",
        "hardhat:core:cli:main",
        "hardhat:core:cli:telemetry:analytics",
        "hardhat:core:cli:telemetry:analytics:utils",
        "hardhat:core:cli:telemetry:global-error-handlers",
        "hardhat:core:cli:telemetry:permissions",
        "hardhat:core:cli:telemetry:sentry:reporter",
        "hardhat:core:cli:telemetry:sentry:subprocess",
        "hardhat:core:cli:telemetry:sentry:transport",
        ...
        "hardhat:core:network-manager:edr:provider",
        "hardhat:core:network-manager:edr:trace-output",
        ...
        "hardhat:core:tasks:console:test",
        "hardhat:core:tasks:node",
        "hardhat:core:tasks:node:artifacts",
        "hardhat:core:tasks:node:json-rpc:server",
        "hardhat:ethers:provider",
        "hardhat:ignition-core:onchain-interaction-monitor",
        "hardhat:ignition:modules",
        "hardhat:keystore:hook-handlers:config",
        "hardhat:ledger:handler",
        ...
        "hardhat:verify:blockscout",
        "hardhat:verify:etherscan",
        "hardhat:verify:metadata",
      ];
