...
const hardhatIgnitionPlugin: HardhatPlugin = {
  ...
  tasks: [
    ...
    task(["ignition", "deploy"], "Deploy a module to the specified network")
      ...
      .setAction(async () => await import("./internal/tasks/deploy.js"))
      .build(),
    task(["ignition", "status"], "Show the current status of a deployment")
      ...
      .setAction(async () => await import("./internal/tasks/status.js"))
      .build(),
    task(["ignition", "deployments"], "List all deployment IDs")
      .setAction(async () => await import("./internal/tasks/deployments.js"))
      .build(),
    task(
      ...
      .setAction(async () => await import("./internal/tasks/transactions.js"))
      .build(),
    task(["ignition", "wipe"], "Reset a deployment's future to allow rerunning")
      ...
      .setAction(async () => await import("./internal/tasks/wipe.js"))
      .build(),
    task(["ignition", "visualize"], "Visualize a module as an HTML report")
      ...
      .setAction(async () => await import("./internal/tasks/visualize.js"))
      .build(),
    ...
    task(
      ...
      .setAction(async () => await import("./internal/tasks/verify.js"))
      .build(),
    task(
      ["ignition", "track-tx"],
      ...
      .setAction(async () => await import("./internal/tasks/track-tx.js"))
      .build(),
    task(
      ["ignition", "migrate"],
      ...
      .setAction(async () => await import("./internal/tasks/migrate.js"))
      .build(),
  ],
};
